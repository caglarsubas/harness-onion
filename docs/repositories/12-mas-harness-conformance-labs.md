...
`CONF-DIAG-003` is a read-only full-backend diagnostic of draft25fab12, not a coding PR or acceptance predecessor; one attempt only after MET-PERF-009 source gates.
