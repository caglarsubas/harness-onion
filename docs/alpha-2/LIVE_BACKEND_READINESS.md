...
[Document repair authority](DOCUMENT_REPAIR_AUTHORITY.md): Alpha2 ONGOING.
...
[Private document repair plan](DOCUMENT_REPAIR_PLAN.md): Alpha2 ONGOING.
...
[Completion profiling reconciliation](COMPLETION_PROFILING.md): Alpha2 ONGOING.
...
[Conformance completion amendment](CONFORMANCE_COMPLETION.md) is current.
...
[Conformance publication decision](CONFORMANCE_PUBLICATION.md) is current.
