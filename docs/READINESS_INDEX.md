...
report records 107 packets; the current catalog has 121; the first repair retains its 114-packet snapshot. This index is a plan,
...
- [`task-packets/README.md`](../task-packets/README.md): the 121-packet execution
...
historical; that publication contained 118 packets; the current approved repair contains 121.
...
Current catalog: 121 packets. Historical 118/120-packet publications remain byte-identical.
