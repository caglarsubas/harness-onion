...
That publication contains 121 packets; the current catalog contains 140. The prior 120-packet amendment and
...
The current catalog has 142 packets. The consumed MET-REPAIR-005 packet and
