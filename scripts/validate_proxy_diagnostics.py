...
RECORD_SHA256 = "b8e7cdc905ea75e030d6495feeeb962a909f6783e3b30333cb31446d0356d56c"
NEW_IDS = ("MET-PERF-006", "CONF-DIAG-001")
RECORD_FILE_SHA256 = "9695b51e7bb10a78bccf4f0ebc068e3e2b2436a3efd7ad926d1473d5f2843a56"
...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 156 and len(packets) == 158 and set(packets) == old | set(NEW_IDS), '158 specifications with156 immutable predecessors')
        for name in packets:
        ...
        for path, rule in record['metaRecipes'].items():
            ...
            require(apply_recipe(before,rule) == inputs[path], 'reversible amendment')
