...
RECORD_SHA256 = "02cb8077f4a1a64444750c98b9c57e0d89e52dcdee7af385f8c3d4382674a46c"
NEW_IDS = ("MET-ACCEPT-001",)
RECORD_FILE_SHA256 = "317726e4fadefbb5b86b4dfb118fa1a8fd6f403920023f7eedc73e68719adea3"
...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 161 and len(packets) == 162 and set(packets) == old | set(NEW_IDS), '161 unchanged plus one META')
...
if __name__ == '__main__':
    ...
    if errors:
        print('\n'.join(errors))
        raise SystemExit(1)
    print('Local acceptance authority valid:162 specifications;161 unchanged packets; one additional local-only attempt.')
