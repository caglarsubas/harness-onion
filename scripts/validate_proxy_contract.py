...
ADDITIONS = ("MET-REPAIR-009", "MET-REPAIR-010", "MET-REPAIR-011", "CONF-FIX-004", "MET-PERF-001", "MET-REPAIR-012", "CONF-FIX-005", "MET-REPAIR-013")
...
def main():
    ...
    for error in errors:
        print("ERROR: " + error)
    if not errors:
        print("Proxy prerequisite valid: 142 packets; 176 immutable authority files; 127-file/279-ID source checkpoint; product/native NOT_RUN.")
