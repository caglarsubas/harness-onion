...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 144 and len(packets) == 168 and set(packets) == old | set(NEW_IDS) | {"MET-PERF-003", "CONF-PERF-002", "MET-PERF-004", "CONF-PERF-003", "MET-PERF-005", "CONF-PERF-004", "CONF-BENCH-001", "MET-REPAIR-016", "CONF-FIX-006", "MET-ADOPT-001", "MET-PERF-006", "CONF-DIAG-001", "MET-PERF-007", "MET-PERF-008", "CONF-DIAG-002", "MET-ACCEPT-001", "MET-PUBLISH-001", "MET-REPAIR-017", "CONF-FIX-007", "MET-ADOPT-002", "MET-PERF-009", "CONF-DIAG-003"}, "exact148 catalog")
...
def main():
    ...
    for error in errors:
        print("ERROR: "+error)
    if not errors:
        print("Conformance performance authority valid: 168 packets; 144 immutable YAML; 127/327 checkpoint; product/native NOT_RUN.")
