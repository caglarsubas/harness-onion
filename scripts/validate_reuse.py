...
def _validate_path_index(
    ...
    _require(
        ...
        == "103 task packets; all current source paths are reference-only and validation status is reported separately",
...
def _validate_task_packet_closure(
    ...
    _require(len(packet_paths) == 103, f"expected 103 task packets, found {len(packet_paths)}")
