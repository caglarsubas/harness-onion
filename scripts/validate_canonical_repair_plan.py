...
RECORD_SHA256 = "52074912439082d769f143259914d7ca2efe96d5c8d17aaab2b8d80da46ea420"
NEW_IDS = ("MET-PERF-007",)
RECORD_FILE_SHA256 = "4e40ec246b400e1e536b08583d6f31e470b3c1da9041e206ee650416bdf9238d"
...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 158 and len(packets) == 159 and set(packets) == old | set(NEW_IDS),
        ...
        for path, rule in record['metaRecipes'].items():
            ...
            require(apply_recipe(before,rule) == inputs[path], 'exact reversible bridge')
