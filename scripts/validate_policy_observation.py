...
ADDITIONS = ("MET-REPAIR-010", "MET-REPAIR-011", "CONF-FIX-004", "MET-PERF-001", "MET-REPAIR-012", "CONF-FIX-005", "MET-REPAIR-013", "MET-REPAIR-014", "MET-REPAIR-015", "MET-PERF-002", "CONF-PERF-001")
ZERO = "sha256:" + "0" * 64
...
def main():
    ...
    for error in errors:
        print("ERROR: " + error)
    if not errors:
        print("Policy observation authority valid: 146 packets; unchanged 127-file/279-ID baseline; DATA_CHECK_ONLY, product/native NOT_RUN.")
