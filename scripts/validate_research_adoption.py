...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 165 and len(packets) == 179 and set(packets) == old | set(NEW_IDS) | {'MET-PERF-010', 'MET-PERF-009', 'CONF-DIAG-003', 'MET-PERF-011', 'MET-PERF-012', 'CONF-PERF-006', 'CONF-BENCH-002', 'MET-PERF-013', 'CONF-BENCH-003', 'MET-REPAIR-018', 'CONF-FIX-008', 'MET-PERF-014', 'CONF-DIAG-004'}, '165 immutable plus one META')
...
if __name__ == '__main__':
    ...
    print('Research adoption authority valid:179 specifications;165 unchanged packets;16 harnesses/13 repositories; no provider qualification or product execution.')
