...
def validate_model_fixture_scope(packets: Any, record: Any, snapshots: Any) -> list[str]:
    ...
    if len(packets) != 177:
        errors.append("current catalog requires exactly 177 packets; fixture publication remains 122")
...
def main() -> int:
    ...
    for error in errors:
        print("ERROR: " + error)
    if not errors:
        print("Model fixture authority valid: 177 packets; historical 122-packet helper grant unchanged; product/native acceptance unproven.")
