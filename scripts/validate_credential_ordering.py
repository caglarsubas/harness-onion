...
def validate_credential_ordering(packets, record, inputs):
    try:
        ...
        require(len(old) == 141 and len(packets) == 150 and set(packets) == old | {"MET-REPAIR-013", "MET-REPAIR-014", "MET-REPAIR-015", "MET-PERF-002", "CONF-PERF-001", "MET-PERF-003", "CONF-PERF-002", "MET-PERF-004", "CONF-PERF-003"},
...
def main():
    ...
    for error in errors:
        print("ERROR: " + error)
    if not errors:
        print("Credential ordering valid: 150 packets; 127/327 source checkpoint; DATA_CHECK_ONLY; product/native NOT_RUN.")
