...
CURRENT_PACKET_COUNT = 165
HISTORICAL_PACKET_COUNT = 139
SUCCESSOR_ADDITIONS = ("MET-REPAIR-012", "CONF-FIX-005", "MET-REPAIR-013", "MET-REPAIR-014", "MET-REPAIR-015", "MET-PERF-002", "CONF-PERF-001", "MET-PERF-003", "CONF-PERF-002", "MET-PERF-004", "CONF-PERF-003", "MET-PERF-005", "CONF-PERF-004", "CONF-BENCH-001", "MET-REPAIR-016", "CONF-FIX-006", "MET-ADOPT-001", "MET-PERF-006", "CONF-DIAG-001", "MET-PERF-007", "MET-PERF-008", "CONF-DIAG-002", "MET-ACCEPT-001", "MET-PUBLISH-001", "MET-REPAIR-017", "CONF-FIX-007")
...
def main():
    ...
    for error in errors:
        print("ERROR: " + error)
    if not errors:
        print("CI performance authority valid: 165 packets; historical 139 authority and all prior tests/both complete replays preserved; no native acceptance.")
