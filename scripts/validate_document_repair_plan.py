...
RECORD_SHA256 = '282e695eb561d83275583c52c9e6488180f52ef36f86b71418b09f1b0c4b8df4'
NEW_IDS = ("MET-PERF-011",)
RECORD_FILE_SHA256 = '9f6d6740fb75c4b1e8e43db431e683908410150dcd8e4b71005d2afd86806076'
...
def validate_plan(value, *, bind=True):
    ...
    require(value['budgets']==dict(metaLocal=2,metaCI=2,metaExactMain=1,productRuns=0,
