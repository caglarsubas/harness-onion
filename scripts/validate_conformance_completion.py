...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 163 and len(packets) == 173 and set(packets) == old | set(NEW_IDS) | {'MET-ADOPT-002', 'MET-PERF-010', 'MET-PERF-009', 'CONF-DIAG-003', 'MET-PERF-011', 'MET-PERF-012', 'CONF-PERF-006', 'CONF-BENCH-002'}, '163 immutable plus two successors')
...
if __name__ == '__main__':
    ...
    print('Conformance completion authority valid:173 specifications;163 unchanged packets; correction required before004; no product/native acceptance.')
