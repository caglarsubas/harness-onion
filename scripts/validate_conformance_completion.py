...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 163 and len(packets) == 169 and set(packets) == old | set(NEW_IDS) | {'MET-ADOPT-002', 'MET-PERF-010', 'MET-PERF-009', 'CONF-DIAG-003'}, '163 immutable plus two successors')
...
if __name__ == '__main__':
    ...
    print('Conformance completion authority valid:169 specifications;163 unchanged packets; correction required before004; no product/native acceptance.')
