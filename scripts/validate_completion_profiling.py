...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 167 and len(packets) == 179 and set(packets) == old | set(NEW_IDS) | {"MET-PERF-011", "MET-PERF-012", "CONF-PERF-006", "CONF-BENCH-002", "MET-PERF-013", "CONF-BENCH-003", "MET-REPAIR-018", "CONF-FIX-008", "MET-PERF-014", "CONF-DIAG-004"}, '167 immutable plus two new packets')
...
if __name__ == '__main__':
    ...
    print('Completion profiling authority valid:179 specifications;167 immutable packets; one diagnostic, no acceptance reset.')
