...
RECORD_SHA256 = 'b5ea793e0ab43d5bac447b8181d282f5922f925cc925f99a7ae960554c189a63'
NEW_IDS = ('MET-PERF-012', 'CONF-PERF-006', 'CONF-BENCH-002')
RECORD_FILE_SHA256 = '9e121640ab80025aaed8393865ceeeaee443e6aa3448714c16f51afb98d9d2bb'
...
def validate_spec(value, *, bind=True):
    ...
    require(value['budgets'] == dict(meta={'LOCAL':2,'CI':2,'LOCAL_EXACT_MAIN':1}, product={'LOCAL':2,'CI':2,'LOCAL_EXACT_MAIN':1}, measurement={'runs':4,'retries':0}, resetOld=False), 'finite separate nontransferable allowances')
