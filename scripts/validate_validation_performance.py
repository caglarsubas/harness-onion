...
def validate_authority(packets, record, inputs):
    try:
        ...
        require(len(old) == 166 and len(packets) == 170
                and set(packets) == old | set(NEW_IDS) | {"MET-PERF-009", "CONF-DIAG-003", "MET-PERF-011"}, "166 immutable predecessors plus one repair")
...
if __name__ == "__main__":
    ...
    if errors:
        print("\n".join(errors))
        raise SystemExit(1)
    print("Validation-performance authority valid:170 specifications;166 unchanged packets; "
