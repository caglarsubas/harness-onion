...
RECORD_SHA256 = "06abab4697b21a009adbc893d5ef3149de24cadefd18f3da5da11ecc2684faba"
NEW_IDS = ("MET-PERF-010",)
RECORD_FILE_SHA256 = "410192ed41fa8fe0b0b2d829988c8d3da7cd2d20838e74fbb765b13baa92adc2"
...
def validate_spec(spec, *, bind=True):
    ...
    require(spec["budgets"] == {"LOCAL": 2, "CI": 2, "LOCAL_EXACT_MAIN": 1,
