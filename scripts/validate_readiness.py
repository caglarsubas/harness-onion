...
def validate_packets(
    ...
    validation.require(
        ...
        "task packet files must exactly match the 93 packets declared by repository plans",
    )
    ...
    validation.require(
        ...
        "task-packets README must index each of the 93 individual packet files exactly once",
    )
