...
def test_exact72_closed_overlaps_preserve_generic_diagnostics(authority):
    ...
    assert len(generic) == 81 and len(record["overlapPairs"]) == 10
...
def test_dispatch_never_hides_changed_or_unrelated_packets(authority, fault):
    ...
    allowed.extend(["CONF-BENCH-001 and CONF-FIX-006","CONF-FIX-006 and CONF-PERF-001","CONF-FIX-006 and CONF-PERF-002","CONF-FIX-006 and CONF-PERF-003", "CONF-DIAG-001 and CONF-LIVE-003"])
